...
cube.js : Main-WebGL.hs Solver.hs Pieces.hs Cube.hs
	stack exec -- hastec Main-WebGL.hs -o cube.js --opt-whole-program=on --opt-minify=on --onexec --own-namespace --with-js=worker-ns-patch.js -odir .crap -hidir .crap --outdir=.crap
